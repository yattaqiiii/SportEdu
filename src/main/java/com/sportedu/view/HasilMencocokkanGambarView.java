 ...
 * Menggunakan UI yang sama dengan HasilTebakGambarView dan HasilQuizView - responsive dan clean
 */
public class HasilMencocokkanGambarView {
    ...
    public void displayHasil(int skorBenar, int totalSoal) {
        // Cari result container menggunakan pattern yang sama seperti HasilQuizView
        ...
        double persentase = (double) skorBenar / totalSoal * 100;
        String pesan;
